...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0Nn0:1nBM3y:caOfJqgYAMru_kklsf4hcphpvuc'
        try:
            Check.equal("izracunaj('10', '5', '+')", '15')
            Check.equal("izracunaj('5', '3', '*')", '15')
            Check.equal("izracunaj('2', '7', '*')", '14')
            Check.equal("izracunaj('4', '3', '+')", '7')
            Check.equal("izracunaj('8', '9', '+')", '17')
            Check.equal("izracunaj('4', '3', '*')", '12')
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])

    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0N30:1nBM3y:4ML4GtLHDue9d70fynwPd0HvgHs'
        try:
            ...
            Check.equal("vrednost_rpn('8 4 3 2 * * + 5 2 * + 2 + 0 +')", 44)
            Check.equal("vrednost_rpn('2 5 * 8 3 * + 6 + 2 *')", 80)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])

    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0OH0:1nBM3y:2MYEVITRilZymd18IjNMEzrkSCM'
        try:
            ...
            Check.equal("obicajni_zapis('8 4 3 2 * * + 5 -2 * + 2 + 0 +')",
                  '((((8 + (4 * (3 * 2))) + (5 * -2)) + 2) + 0)')
            Check.equal("obicajni_zapis('2 5 * 8 -3 * + 6 + 2 *')",
                  '((((2 * 5) + (8 * -3)) + 6) * 2)')
            Check.equal("obicajni_zapis('2 3 2 + * 1 + 2 * 3 1 2 + * +')",
                  '((((2 * (3 + 2)) + 1) * 2) + (3 * (1 + 2)))')
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
