...
##        
    ...
    for el in niz:
        if el != ' ':
            niz1 += el
    r_n1 = nadomestni_upor(int(niz1[0]),int(niz1[1]),niz1[2])
    i=2
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0Mn0:1mz2kr:F4owkwd-rSAQ7VGg_YjwHfTn7nk'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0M30:1mz2kr:zRI3SS51qix6xToFL0oiwJRVh58'
        try:
            test_data = [
                ("upor_vezja('3 5 Z')", 8),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0NH0:1mz2kr:MgP1AFbb1tawUElpJMne1xmNrw0'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE0NX0:1mz2kr:vUa411KmXcWHQfOyEPiE6VnuS_w'
        try:
            test_data = [
                ("stari_macki('3 5 Z')", 8),
