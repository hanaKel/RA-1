...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE1Nn0:1nBMDt:fjSeF9ltV2kHrSeFpiZD4tDNM4U'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """s.vstavi(5)""",
                  """s.vstavi(3)""",
                  """s.vstavi(1)""",
                  """p = prestej_elemente(s)""",
                  """izpis = str(s)"""],
                 {'p': 3, 'izpis': 'DNO : 5 : 3 : 1 : VRH'}),
                (["""s = Sklad()""",
                  """s.vstavi(6)""",
                  """s.vstavi(1)""",
                  """s.vstavi(3)""",
                  ...
                  """p = prestej_elemente(s)""",
                  """izpis = str(s)"""],
                 {'p': 5, 'izpis': 'DNO : 6 : 1 : 3 : 4 : 5 : VRH'}),
                (["""s = Sklad()""",
                  """for i in range(115):""",
                  """    s.vstavi(i)""",
                  """p = prestej_elemente(s)""",
                  """izpis = str(s)"""],
                 {'p': 115, 'izpis': 'DNO : ' + ' : '.join(str(x) for x in range(115)) + ' : VRH'}),
                (["""s = Sklad()""",
                  """p = prestej_elemente(s)""",
                  """izpis = str(s)"""],
                 {'p': 0, 'izpis': 'DNO : VRH'}),
