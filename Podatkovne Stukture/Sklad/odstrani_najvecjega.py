...
# odstranijo največji podatek. Seveda je potrebno uporabljati le metode nad
# skladom, na koncu mora pa biti vrstni red elementov (tistih, ki ostanejo v
# skladu) nespremenjen. Če je v skladu le en največji podatek, se vse tri
# funcije obnašajo enako. Če pa sta dva ali celo več enakih največjih
# elementov, lahko postopamo na več možnih načinov:
# 
#  * odstranimo le najstarejšega (tistega, ki smo ga prvega vstavili v sklad)
#    največjega;
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTEzNH0:1meJHQ:8keTIm5H15W3tHY6mCLkA4aHJzE'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTEzNX0:1meJHQ:q8DWoUNV7H2z3SDn6liQLq3r7Vo'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
                  ...
                  's.odstrani_najstarejsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : 0 : 1 : 0 : 1 : 2 : 0 : 1 : 2 : 0 : VRH'}),
                (['s = Sklad()',
                  's.odstrani_najstarejsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : VRH'}),
                (['s = Sklad()',
                  ...
                  's.odstrani_najstarejsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : 8 : 6 : 10 : 14 : 13 : VRH'}),
                (['s = Sklad()',
                  'for x in [3, 2, 1, 2, 3]:',
                  '    s.vstavi(x)',
                  's.odstrani_najstarejsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : 2 : 1 : 2 : 3 : VRH'}),
                (['s = Sklad()',
                  'for x in [3, 2, 1]:',
                  '    s.vstavi(x)',
                  's.odstrani_najstarejsega_najvecjega()',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTEzNn0:1meJHQ:e1kUGBkWYi9wlQFbMmmTgiGBKag'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
                  ...
                  's.odstrani_najmlajsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : 0 : 1 : 2 : 0 : 1 : 2 : 0 : 1 : 0 : VRH'}),
                (['s = Sklad()',
                  's.odstrani_najmlajsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : VRH'}),
                (['s = Sklad()',
                  ...
                  's.odstrani_najmlajsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : 8 : 6 : 14 : 10 : 13 : VRH'}),
                (['s = Sklad()',
                  'for x in [3, 2, 1, 2, 3]:',
                  '    s.vstavi(x)',
                  's.odstrani_najmlajsega_najvecjega()',
                  'izpis = str(s)'],
                 {'izpis': 'DNO : 3 : 2 : 1 : 2 : VRH'}),
                (['s = Sklad()',
                  'for x in [3, 2, 1]:',
                  '    s.vstavi(x)',
                  's.odstrani_najmlajsega_najvecjega()',
