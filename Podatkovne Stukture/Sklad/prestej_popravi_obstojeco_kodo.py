...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTEzMX0:1meJHQ:Avr62TyXzva8NQW9GI6qoOdKbCs'
        try:
            test_data = [
                (['s = Sklad()',
                  's.vstavi(6)',
                ...
                (['s = Sklad()',
                  ...
                  'p = prestej_elemente(s)',
                  'izpis = str(s)'],
                 {'p': 5, 'izpis': 'DNO : 6 : 1 : 2 : 4 : 8 : VRH'}),
                (['s = Sklad()',
                  'for i in range(107):',
                  '    s.vstavi(i)',
                  'p = prestej_elemente(s)',
                  'izpis = str(s)'],
                 {'p': 107, 'izpis': 'DNO : ' + ' : '.join(str(x) for x in range(107)) + ' : VRH'}),
                (['s = Sklad()',
                  'p = prestej_elemente(s)',
                  'izpis = str(s)'],
                 {'p': 0, 'izpis': 'DNO : VRH'}),
