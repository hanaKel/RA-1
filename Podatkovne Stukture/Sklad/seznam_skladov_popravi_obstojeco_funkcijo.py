...
# čemer $i$-ti sklad ($i = 0, 1, \ldots, 9$) vsebuje tista števila s sklada
# `sklad`, ki dajo ostanek $i$ pri deljenju z 10. Funkcija vsebuje več napak.
# Odpravi jih.
# Zgled:
# 
#     >>> s = Sklad()
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTEzOX0:1meJIf:ZOTrQaPdRdlb6dpkwgKVyUNjgd8'
        try:
            Check.run(
                [
                    's = Sklad()',
                    ...
                    's.vstavi(23)',
                    'r = locevanje(s)',
                    'prazno = all([r[0].prazen(), r[1].prazen(), r[6].prazen(), r[7].prazen(), r[8].prazen(), r[9].prazen()])',
                    's2 = str(r[2])',
                    's3 = str(r[3])',
                    's4 = str(r[4])',
                    's5 = str(r[5])'
            ...
            Check.run(
                [
                    's = Sklad()',
                    'for i in range(10): s.vstavi(i)',
                    'for i in range(19, 10, -1): s.vstavi(i)',
                    's.vstavi(20)',
                    'r = locevanje(s)',
                    's0 = str(r[0])',
                    's1 = str(r[1])',
            ...
            Check.run(
                [ 's_secret = Sklad()',
                  ...
                  'for i in range(21): (s_secret.vstavi(i), s_secret.vstavi(100 - i))',
                  'r = locevanje(s_secret)',
                  's0 = str(r[0])',
                  's1 = str(r[1])',
                  's9 = str(r[9])'
             ],
                {
                    's0': 'DNO : 0 : 100 : 10 : 90 : 20 : 80 : VRH',
                    's1': 'DNO : 1 : 91 : 11 : 81 : VRH',
                    's9': 'DNO : 99 : 9 : 89 : 19 : VRH'
                }
            )
        except:
