...
def vstavi_v_iskalno_drevo(drevo, x):
    if drevo.prazno:
        ...
        if drevo.levo.prazno:
            ...
            l = vstavi_v_iskalno_drevo(drevo.levo, x)
    elif x > drevo.podatek:
        if drevo.desno.prazno:
            drevo.desno = Drevo(x)
        else:
            d = vstavi_v_iskalno_drevo(drevo.desno, x)
    return drevo
# =====================================================================@029280=
# 2. podnaloga
...
def ali_vsebuje(drevo, x):
    if drevo.prazno:
        ...
        return True
    elif x < drevo.podatek and not drevo.levo.prazno:
        l = ali_vsebuje(drevo.levo, x)
    elif x > drevo.podatek and not drevo.desno.prazno:
        d = ali_vsebuje(drevo.desno, x)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI3OX0:1mxXv4:mWtCf8JD70DCe5uM9DqMU2yVk04'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4MH0:1mxXv4:iR8-ySVhh3BmUjOY0LJ8uA5nxJI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4MX0:1mxXv4:nlM70YWAxTIFovtFlwp15dL7iyQ'
        try:
            Check.run([
                'mn = Mnozica()',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4Mn0:1mxXv4:AxqveiAw7pgBwPgv7bZXwlWB-do'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4M30:1mxXv4:LZg4ZpXFR6KdOL4e6lZM3W6AlTA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4NH0:1mxXv4:eWZtTTmU2UeL7R0y0qQJ37uQ9vw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4NX0:1mxXv4:rp_V7-vjIqSjgzR8SWVgGRqGKBA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI4Nn0:1mxXv4:8B6k2fdE_J6Y_wKLy_vQQvlOPgM'
        try:
            pass
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
