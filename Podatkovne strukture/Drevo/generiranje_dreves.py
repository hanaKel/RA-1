...
def polno_drevo_nicel(n):
    if n <= 0:
        return Drevo()
    else:
        leva = polno_drevo_nicel(n - 1)
        desna = polno_drevo_nicel(n - 1)
        return Drevo(0, levo = leva, desno = desna)
...
def polno_drevo_globin(n, i = 0):
    if n <= 0:
        return Drevo()
    else:
        while n > 0:
            i += 1
            leva = polno_drevo_globin(n - 1, i)
            desna = polno_drevo_globin(n - 1, i)
            return Drevo(i, levo = leva, desno = desna)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2MH0:1msPCK:Osj33adoOShCvK3DLGsaL-eBirw'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2MX0:1msPCK:x41fK8kB5NULQEkPRFtE8lqxoAE'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2Mn0:1msPCK:iBRxdnzJf3VZuA0ZGVOV8sdKkQQ'
        try:
            tests = [
                ('polno_drevo_globin(0)', Drevo()),
                ('polno_drevo_globin(1)', Drevo(1)),
                ('polno_drevo_globin(3)', Drevo(1, levo=Drevo(2, levo=Drevo(3), desno=Drevo(3)), desno=Drevo(2, levo=Drevo(3), desno=Drevo(3))))
            ]
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2M30:1msPCK:_PA8GB9uQjrIZf016xkNIjPKrrU'
        try:
            tests = [
                ('drevo_vsot([])', Drevo()),
