...
kaj_je_delalo_in_kaj_ni = '''pri Generiranje dreves nič ni delalo '''
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI1NH0:1msPlP:HJ41Pg5RJJOR85OB4KIlP0q-c4M'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI1NX0:1msPlP:3i-9aKTmaiGpfuR4YcpQVxWs8WA'
        try:
