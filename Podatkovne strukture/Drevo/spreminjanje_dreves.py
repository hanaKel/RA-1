...
# =============================================================================
    def potroji(self):
        if self.prazno:
            ...
            self.levo.potroji()
            self.desno.potroji()
            self.levo = Drevo(self.podatek, levo = self.levo)
            self.desno = Drevo(self.podatek, desno = self.desno)
# =====================================================================@029269=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2N30:1muz9I:JkzuKR0UF9udcX_SNkSIl0clVo0'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2OH0:1muz9I:RbkxP6N-souCAtsDI0oAjF5DqmE'
        try:
            test_data = [
                (["d = Drevo(5, levo=Drevo(3), desno=Drevo(2))",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTI2OX0:1muz9I:7kKYrV10zioVHPuBAcgdi9hpzAg'
        try:
            test_data = [
                (["d = Drevo(5, levo=Drevo(3), desno=Drevo(2))",
