...
def zadnji_vozel(prvi):
    tabela = vrni_seznam(prvi)
    if tabela == []:
        return None
    nov = None
    nov = dodaj_na_zacetek(nov, tabela[-1])
    return nov   
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTIyMH0:1nBh0M:aclRlYpKncZVrrzcmIDDUgZhH9g'
        try:
            test_data = [
                (["n = dolzina(None)"],
                 {'n': 0}),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTIyMX0:1nBh0M:04S72UF4lrjN8OH8RiaqrZh5Vqk'
        try:
            test_data = [
                (["v = iz_seznama(['sreda', 'četrtek', 'petek', 'sobota'])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTIyMn0:1nBh0M:jdQjVgXmq635pgp6Nm31gN1wpLs'
        try:
            test_data = [
                ('seznam_sodih(None)', []),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTIyM30:1nBh0M:JTyNKYVZhEdR9Dr4qweTyE8Cx1s'
        try:
            test_data = [
                (["v = iz_seznama(['sreda', 'četrtek', 'petek', 'sobota'])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTIyNH0:1nBh0M:ILboCt3qszUTjhSZ9ikIkCWV03g'
        try:
            test_data = [
