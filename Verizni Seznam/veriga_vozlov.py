...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE3OH0:1nBgSf:i76da-Sqt6aq1IBLXUJaW6HAHWI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE3OX0:1nBgSf:GxfvfnbS_6MlU7lZqIiCieWPoOs'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE4MH0:1nBgSf:K5mbS_2p7ePBCVUzWLHMrYAEzLE'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTE4MX0:1nBgSf:adPfDk1FGb_UHTnXBVj1kvZlt2s'
        try:
            test_data = [
                (["v = iz_seznama([])",
                  "l = vrni_seznam(v)"],
