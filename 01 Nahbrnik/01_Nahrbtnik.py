...
def preveri(s):
    ...
    for elt in s:
        if len(elt) != 2:
            ...
            return False
        elif not (isinstance(elt[0], int) or isinstance(elt[1], int)) or elt[0] < 0 or elt[1] < 0:
            return False
        prej = elt[0]
    return True
...
def mnoziceS(predmeti):
    prva = [(0, 0)]
    rezultat = []
    rezultat.append(prva)
    for par in predmeti:
        prva_z = sestaviZ(prva, par) 
        prva = sestaviS(prva, prva_z)
        rezultat.append(prva)
    return rezultat
# =====================================================================@029310=
# 5. podnaloga
...
def nahrbtnik01(predmeti, velikost):
    vsiS = mnoziceS(predmeti)
    vmes_velikost = 0
    max_par = (0, 0)
    for sez in vsiS:
        for t, v in sez:
            if t < velikost and t > vmes_velikost:
                max_par = (t, v)
    return max_par
# =====================================================================@029311=
# 6. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMwNn0:1n7eqI:YAXWptO77sA2HTVlr8WVyLwfeg8'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMwN30:1n7eqI:z24afp6YVd6Bguwdr_pyzhDEkuM'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMwOH0:1n7eqI:STPZtVUzfFxj2GjTfjGsJXf4Gug'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMwOX0:1n7eqI:IpOnOJetU4cPKAax2QaFd2vBLoE'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMxMH0:1n7eqI:KvyXH5eswM7kqOVMct5D0fYyc3w'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMxMX0:1n7eqI:5DnR5mf7pw-ookV4ub2vWjtFaHA'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMxMn0:1n7eqI:Ada8W-hLgCb8exWQ0eatzxqeXy0'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2ODQ4LCJwYXJ0IjoyOTMxM30:1n7eqI:CNlv4XPk8f347r_zhUtWwxUMVuM'
        try:
            test_data = [
